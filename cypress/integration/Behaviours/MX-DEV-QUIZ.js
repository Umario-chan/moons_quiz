...
describe('SuiteTest_Alineadores', function(){
    ...
    devices.forEach((device) => {
        ...
        //it.only('Open the Quiz Page', function(){   
        //    cy.fixture('quiz').then(function(data){
        //        this.data=data
        //        cy.visit(this.data.MX_DEV_QUIZ)
        //    })
        ...
        it('Moons003 - Validate the stickers', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('Moons004 - Validate the footer', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('Moons002 - Validate the Questions ', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
