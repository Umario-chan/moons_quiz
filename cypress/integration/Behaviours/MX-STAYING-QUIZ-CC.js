...
describe('SuiteTest_Alineadores', function(){
    ...
    devices.forEach((device) => {
        context('Moons Quiz' , () => {
            beforeEach(() => {
                ...
                cy.fixture('quiz').then(function(data){
                    this.data=data
                    cy.visit(this.data.MX_STAYING_QUIZ_CC)
                })
           })
        ...
        //    })
        //    })
        it('MOONS_001 - Validate the Header', function(){
        ...
        it('MOONS_002 - Validate the Questions ', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_003 - Validate Submit button', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_004 - Validate the footer', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_005 - Submit the quiz without data', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data    
        ...
        it('MOONS_006 - Submit the quiz with question 1 answered', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_007 - Submit the quiz with question 1 and 2 answered without name', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_008 - Submit the quiz with question 1 and 2 answered with wrong name', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_009 - Submit the quiz with question 1,2 and 3 without Last name answered', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_010 - Submit the quiz with question 1,2 and 3 with wrong Last name answered', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_011 - Submit the quiz with question 1,2,3 without Email', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_012 - Submit the quiz with question 1,2,3 with WRONG Email', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_013 - Submit the quiz with question 1,2,3 and 4 without phoneNumber', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_014 - Submit the quiz with question 1,2,3 and 4 with incorrectNumber', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_015 - Submit the quiz with question 1,2,3 and 4 with incompleteNumber', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_016 - Submit the quiz with question 1,2,3 and 4 with completeNumber', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_017 - Submit the quiz with question 1,2,3 and 4 without Comercial Center', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_018 - Submit the quiz with All DATA 001', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_019 - Submit the quiz with duplicated data', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS_020 - Submit the quiz with UPPERCASE data', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getCheckBoxPermission().check()
                    quizElements.getComercialCenter().select(this.data.ComercialCenter002)
                    quizElements.getSubmitButton().click()
                    cy.contains(this.data.AnswersReview)
                    cy.wait(12000) 
        ...
        it('MOONS_021 - Submit the quiz with NO candidate Age', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
