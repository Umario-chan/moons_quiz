    ...
    devices.forEach((device) => {
        ...
        it('Open the Quiz Page', function(){   
            cy.fixture('quiz').then(function(data){
                ...
                cy.visit(this.data.CO_DEV_MOONS1925)
            })
            })
        ...
        it('MOONS-1925_008 - Submit the quiz with question 1 and 2 answered with wrong name', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getImage001().click()
                    //quizElements.getError().should('have.value', this.data.ErrorMessage001)
                    quizElements.getInputName().type(this.data.CO_WrongName001, {force: true})
                    quizElements.getSubmitButton().click()
        ...
        it('MOONS-1925_009 - Submit the quiz with question 1,2 and 3 without Last name answered', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getFirstQuestionDropdown().select(this.data.Age004)
                    quizElements.getImage001().click()
                    quizElements.getInputName().type(this.data.CO_CorrectName001, {force: true})
                    quizElements.getSubmitButton().click()
        ...
        it('MOONS-1925_010 - Submit the quiz with question 1,2 and 3 with wrong Last name answered', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getImage001().click()
                    quizElements.getInputName().type(this.data.CO_CorrectName001, {force: true})
                    quizElements.getInputLastname().type(this.data.CO_WrongLastName, {force: true})
                    quizElements.getSubmitButton().click()
        ...
        it('MOONS-1925_011 - Submit the quiz with question 1,2,3 without Email', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getImage001().click()
                    quizElements.getInputName().type(this.data.CO_CorrectName001, {force: true})
                    quizElements.getInputLastname().type(this.data.CO_CorrectLastName, {force: true})
                    quizElements.getSubmitButton().click()
        ...
        it('MOONS-1925_012 - Submit the quiz with question 1,2,3 with WRONG Email', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getInputName().type(this.data.CO_CorrectName001, {force: true})
                    quizElements.getInputLastname().type(this.data.CO_CorrectLastName, {force: true})
                    quizElements.getInputEmail().type(this.data.CO_WrongEmail001, {force: true})
        ...
        it('MOONS-1925_013 - Submit the quiz with question 1,2,3 and 4 without phoneNumber', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getInputName().type(this.data.CO_CorrectName001, {force: true})
                    quizElements.getInputLastname().type(this.data.CO_CorrectLastName, {force: true})
                    quizElements.getInputEmail().type(this.data.CO_CorrectEmail001, {force: true})
                    quizElements.getSubmitButton().click()
        ...
        it('MOONS-1925_014 - Submit the quiz with question 1,2,3 and 4 with incorrectNumber', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getInputLastname().type(this.data.CO_CorrectLastName, {force: true})
                    quizElements.getInputEmail().type(this.data.CO_CorrectEmail001, {force: true})
                    quizElements.getInputWhatsApp().type(this.data.CO_NumberWithText, {force: true})
                    quizElements.getInputWhatsApp().should('have.value', this.data.CO_NumberWithTextCorrect)
                    quizElements.getSubmitButton().click()
                    cy.contains(this.data.Error006)
        ...
        it('MOONS-1925_015 - Submit the quiz with question 1,2,3 and 4 with incompleteNumber', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getInputLastname().type(this.data.CO_CorrectLastName, {force: true})
                    quizElements.getInputEmail().type(this.data.CO_CorrectEmail001, {force: true})
                    quizElements.getInputWhatsApp().type(this.data.CO_NumberIncomplete, {force: true})
                    quizElements.getSubmitButton().click()
                    cy.contains(this.data.Error006)
        ...
        it('MOONS-1925_016 - Submit the quiz with question 1,2,3 and 4 with completeNumber', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getInputLastname().type(this.data.CO_CorrectLastName, {force: true})
                    quizElements.getInputEmail().type(this.data.CO_CorrectEmail001, {force: true})
                    quizElements.getInputWhatsApp().type(this.data.CO_NumberCorrect001, {force: true})
                    quizElements.getSubmitButton().click()
                    cy.contains(this.data.Error007)
            }) 
        })
        it('MOONS-1925_017 - Submit the quiz with question 1,2,3 and 4 witohut Comercial Center', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
        ...
        it('MOONS-1925_018 - Submit the quiz with All DATA', function(){
            const quizElements=new QuizElements()
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getInputWhatsApp().type(this.data.CO_NumberCorrect001, {force: true})
                    quizElements.getCheckBoxPermissionCo().check()
                    quizElements.getComercialCenterCO().select(this.data.CO_ComercialCenter001)
                    quizElements.getSubmitButton().click()
                    cy.contains(this.data.AnswersReview)
                    cy.wait(10000) 
                    cy.contains(this.data.CO_CorrectName001 + " " + this.data.CO_CorrectLastName)
        ...
        it('MOONS-1925_020 - Submit the quiz with UPPERCASE data', function(){
            ...
            cy.fixture('quiz').then(function(data){
                this.data=data
                    ...
                    quizElements.getFirstQuestionDropdown().select(this.data.Age003)
                    quizElements.getImage001().click()
                    quizElements.getInputName().type(this.data.CO_CorrectUName001, {force: true})
                    quizElements.getInputLastname().type(this.data.CO_CorrectULastName, {force: true})
                    quizElements.getInputEmail().type(this.data.CO_CorrectUEmail001, {force: true})
                    quizElements.getInputWhatsApp().type(this.data.CO_NumberCorrect002, {force: true})
                    quizElements.getCheckBoxPermissionCo().check()
                    quizElements.getComercialCenterCO().select(this.data.CO_ComercialCenter001)
                    quizElements.getSubmitButton().click()
                    cy.contains(this.data.AnswersReview)
                    cy.wait(10000) 
                    cy.contains(this.data.CO_CorrectUName001 + " " + this.data.CO_CorrectULastName)
                    cy.contains(this.data.CorrecrAnswer002)
                    //cy.contains(this.data.Center001).click()
                    cy.wait(15000) 
                    //quizElements.GetPopUpDuplicatedData().should('be.visible')
